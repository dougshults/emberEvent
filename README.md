...
This is uses firebase to hold ember data and is based on the following tutorial with updates made to the routes, components, controllers, and model info. Basically, we're walking through an ember app. ;)
